...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}">
            ...
            <span class="ms-3 font-weight-bold">Telenursing Covid-19</span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ (Request::is('dashboard') || (Route::currentRouteName() == 'tambah.user') || (Route::currentRouteName() == 'edit.user') ? 'active' : '') }}" href="{{ url('dashboard') }}">
            ...
            <li class="nav-item">
                <a class="nav-link {{ (Request::is('dashboard-pasien') || (Route::currentRouteName() == 'detail.assessment') ? 'active' : '') }}" href="{{ url('dashboard-pasien') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    <svg width="12px" height="12px" viewBox="0 0 45 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        <title>shop </title>
                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <li class="nav-item pb-2">
                <a class="nav-link {{ (Request::is('self-assessment') ? 'active' : '') }}" href="{{ url('self-assessment') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i style="font-size: 1rem;" class="fab fa-wpforms ps-2 pe-2 text-center text-dark {{ (Request::is('self-assessment') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
                    </div>
                    <span class="nav-link-text ms-1">Assessment Covid-19</span>
                </a>
            </li>
            @endif
            ...
            <li class="nav-item">
                <a class="nav-link {{ (Request::is('dashboard-dokter') || (Route::currentRouteName() == 'diagnosa') ? 'active' : '') }}" href="{{ url('dashboard-dokter') }}">
                <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    <svg width="12px" height="12px" viewBox="0 0 45 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    <title>shop </title>
                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
