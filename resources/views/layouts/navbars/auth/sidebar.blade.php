...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}">
        ...
        <span class="ms-3 font-weight-bold">RS App</span>
    </a>
  </div>
  ...
  <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      ...
      <li class="nav-item {{Auth::user()->user_role_id !== 4 ? 'd-none' : ''}}">
        <a class="nav-link {{ (Request::is('dashboard-pasien') ? 'active' : '') }}" href="{{ url('dashboard-pasien') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg width="12px" height="12px" viewBox="0 0 45 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <title>shop </title>
              <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
          ...
          <span class="nav-link-text ms-1">Dashboard Pasien</span>
        </a>
      </li>

      <li class="nav-item {{Auth::user()->user_role_id !== 3 ? 'd-none' : ''}}">
        <a class="nav-link {{ (Request::is('dashboard-perawat') ? 'active' : '') }}" href="{{ url('dashboard-perawat') }}">
          ...
          <span class="nav-link-text ms-1">Dashboard Perawat</span>
        </a>
      </li>

      <li class="nav-item {{Auth::user()->user_role_id !== 2 ? 'd-none' : ''}}">
        <a class="nav-link {{ (Request::is('dashboard-dokter') ? 'active' : '') }}" href="{{ url('dashboard-dokter') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg width="12px" height="12px" viewBox="0 0 45 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <title>shop </title>
              <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
      ...
      <li class="nav-item pb-2 {{Auth::user()->user_role_id !== 4 ? 'd-none' : ''}}">
        <a class="nav-link {{ (Request::is('form-keluhan') ? 'active' : '') }}" href="{{ url('form-keluhan') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <i style="font-size: 1rem;" class="fab fa-wpforms ps-2 pe-2 text-center text-dark {{ (Request::is('form-keluhan') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
            </div>
            <span class="nav-link-text ms-1">Form Keluhan</span>
        </a>
      </li>
      <li class="nav-item pb-2 {{Auth::user()->user_role_id !== 3 ? 'd-none' : ''}}">
